...
function climbStairs(n: number): number {
  // each item represents the distinct way to get to the each steps (0, first, second, ..., nth)
...
// Solution 3: space optimized only using two variables instead using the whole array
